                ...
                if Exibir_Lista == 1:  # Realizar o Update sem exibir lista
                    ...
                    if Resultado:  # Verifica se existe valor dentro da variável
                        ...
                        while True:
                            ...
                            Produto.update_one(  # Atuliza o produto pelo codígo
                                {"Código": Selecionar_Codígo},
...
#Hoje, lamento profundamente a perda do meu domingo para um projeto. Este dia, que deveria ter sido de descanso
#e prazer, foi consumido por responsabilidades relacionadas ao projeto. É frustrante ver o projeto invadindo o
#tempo que deveria ser dedicado a momentos significativos e pessoais.
